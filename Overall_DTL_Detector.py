...
from Oxy_SS_modules.Subtree_Clade_Gen import *

#CALL SOMETHING TO MAKE SPECIES TREES
from Oxy_SS_modules.MakeSpeciesTrees_oxy_branch import *

#CALL SOMETHING TO MAKE GENE TREES
from Oxy_SS_modules.MakeGeneTrees_oxy import *

#CALL SOMETHING TO DO PROGRESS IN AND OUT
from Oxy_SS_modules.Progress_InOut import *
from Oxy_SS_modules.Progress_InOut import Pickle_Project_Storage

#CALL SOMETHING TO RUN RANGER DTL
from Oxy_SS_modules.Run_Ranger import *

#CALL SOMETHING TO DO THE SUBSAMPLING
from Oxy_SS_modules.Preform_Subsampling import *

#CLASSES
from Oxy_SS_modules.Classes_DTL_Detector import Fasta
from Oxy_SS_modules.Classes_DTL_Detector import Subtree
...
def Run_Detection(stringlist, treefile, artcutoff, fewnum, treesubfile, inputfasta, verbose, projectname = "NA"):
   ...
   # print(list_of_big_clades)
    ...
    Write_Progress_File(list_of_big_clades, list_of_short_clades, projectname)
   # import pickle
    #pickle_save = Pickle_Progress(list_of_big_clades, list_of_short_clades, orig_fasta, projectname)
...
def run_on_ss_fasta(subfasta,projectname):
    ...
    #
    #I think I just don't for SOD. in future, just add in an outgroup sequence and make it root there.
    #realign and
    #run the gene tree
    #ranger and ranger parser.
    #map the results somehow???? :,((((((((
    #mapping stuff goes here!!

#this isn't implemented yet/maybe ever
def pickle_onwards(picklefile):
    pass
    #this fxn should read pickle file and allow me to test ONLY RANGERDTL onwards
